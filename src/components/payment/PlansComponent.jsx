...
const PlansComponent = () => {
    ...
    const { profileData, backendUrl, getProfileData } = useContext(DoctorContext);
    ...
    const initPayment = async (order) => {
        const options = {
            ...
            description: `${currentPlan?.planType} subscription for bookmydoctor panel`,
        ...
        <div className="flex flex-col items-center min-h-screen mt-4 gap-4 mx-2">
            ...
            <div className="w-full max-w-md bg-white shadow-2xl rounded-2xl p-6 text-center">
                ...
                <button
                    ...
                    className="w-full mt-6 py-2 text-white bg-indigo-700 hover:bg-indigo-800 rounded-lg font-medium transition-all duration-200 flex justify-center items-center disabled:opacity-50"
                >
                    {loader
                        ?
                        <>
