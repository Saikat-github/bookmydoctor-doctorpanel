...
const FormClinicInfo = ({register, errors}) => {
  return (
    <>
              ...
              <textarea type="text" placeholder="Detailed address" className={`py-2 px-3 border border-gray-700 w-full  rounded-sm mt-2`} label="Clinic Address" {...register("address")} required
              ></textarea>
              ...
              <Input type="number" placeholder="Clinic Phone Number" label="Enter Ph Number" {...register("phoneNumber", {
